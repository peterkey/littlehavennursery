...
import { FaUtensils, FaFirstAid, FaShieldAlt, FaComments, FaChild, FaHeart, FaHardHat, FaBook } from "react-icons/fa";

const TrainingCard = ({ icon: Icon, title, description, index }) => (
  <motion.div
  ...
  const trainingItems = [
    {
      icon: FaUtensils,
      title: "Food Hygiene",
      description: "Ensuring safe meal preparation and handling."
    },
    {
      icon: FaFirstAid,
      title: "Paediatric First Aid",
      description: "Trained in handling medical emergencies."
    },
    {
      icon: FaShieldAlt,
      title: "Safeguarding",
      description: "Protecting children's wellbeing and safety."
    },
    {
      icon: FaComments,
      title: "Speech & Language",
      description: "Enhancing children's communication skills."
    },
    {
      icon: FaChild,
      title: "Child-Centred Learning",
      description: "Encouraging independent thinking and creativity."
    },
    {
      icon: FaHeart,
      title: "Wellbeing & Involvement",
      description: "Supporting emotional and social development."
    },
    {
      icon: FaHardHat,
      title: "Health & Safety",
      description: "Ensuring a safe and secure learning environment."
    },
    {
      icon: FaBook,
      title: "Observations & Assessments",
      description: "Tracking child development and progress."
    }
  ];
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            We are committed to continuous learning and professional development. Our staff undergo regular training to
            ensure they provide the highest level of care and education to the children.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {trainingItems.map((item, index) => (
            <TrainingCard key={index} {...item} index={index} />
          ))}
        </div>
