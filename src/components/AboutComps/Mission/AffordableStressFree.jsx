...
const FeatureCard = ({ icon: Icon, title, description, delay }) => (
  ...
  >
    <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-teal-100 
                    transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
      <div className="absolute inset-0 bg-gradient-to-br from-teal-50 to-cyan-50 opacity-0 
                    group-hover:opacity-100 transition-opacity duration-300 rounded-2xl" />
      <div className="relative z-10">
        <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-teal-400 to-cyan-500 
...
const AffordableStressFree = () => {
  const features = [
    ...
    },
    {
      icon: FaWallet,
      title: "Great Value",
      description: "We offer high-quality childcare at an affordable rate, giving you peace of mind that your child is receiving the best care and education."
    }
  ];
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      {/* Decorative Elements */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-teal-400 rounded-full mix-blend-multiply 
                    filter blur-3xl opacity-10 animate-blob" />
      <div className="absolute -bottom-8 left-0 w-64 h-64 bg-cyan-400 rounded-full mix-blend-multiply 
...
export default AffordableStressFree;
