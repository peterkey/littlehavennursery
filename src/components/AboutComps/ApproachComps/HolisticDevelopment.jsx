...
import { FaBrain, FaHeart, FaUsers, FaDumbbell } from "react-icons/fa";
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            A child's growth isn't just about learning facts—it's about developing in all areas. Our approach focuses on
            cognitive, emotional, social, and physical development, ensuring children thrive in every aspect of their
            lives.
          </motion.p>
        </div>
