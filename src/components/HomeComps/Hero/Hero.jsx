...
const Stat = ({ value, label }) => (
  <div className="text-center lg:text-left">
    ...
    <p className="font-sans text-[11px] text-neutral-400 mt-0.5 font-medium whitespace-nowrap">{label}</p>
  </div>
);
...
const Hero = () => (
  <section className="relative bg-[#fffdf8] overflow-hidden">
    ...
    {/* Soft ambient blush orbs */}
    <div aria-hidden="true" className="absolute -top-40 -right-40 w-[520px] h-[520px] bg-primary-100/25 rounded-full pointer-events-none blur-3xl" />
    <div aria-hidden="true" className="absolute top-16 right-16 w-52 h-52 bg-teal-50/60 rounded-full pointer-events-none blur-2xl" />
    <div aria-hidden="true" className="absolute bottom-20 left-0 w-72 h-72 bg-primary-50/40 rounded-full pointer-events-none blur-3xl" />

    {/* Bottom fade into next section */}
    <div aria-hidden="true" className="absolute bottom-0 left-0 right-0 h-28 bg-gradient-to-t from-white/80 to-transparent pointer-events-none" />
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 lg:pt-36 lg:pb-28">
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-12">
        ...
        >
          {/* Eyebrow */}
          <motion.div variants={fadeUp} className="mb-5 flex items-center gap-2.5 justify-center lg:justify-start">
            <span className="w-7 h-px bg-primary-300 flex-shrink-0" />
            <span className="font-sans text-[11px] font-semibold tracking-[0.16em] uppercase text-primary-500">
          ...
          >
            Where<br />
            <span className="text-primary-600 italic">Curiosity</span><br />
            Leads to Learning
          </motion.h1>

          {/* Service badge */}
          <motion.div variants={fadeUp} className="mb-6 flex justify-center lg:justify-start">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-teal-50 border border-teal-200/70 text-teal-700 text-sm font-semibold font-sans rounded-full">
          ...
          <motion.p
            variants={fadeUp}
            className="font-sans text-neutral-600 text-lg leading-relaxed mb-8 max-w-[430px] mx-auto lg:mx-0"
          >
          ...
          >
            <Link to="/booking">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold font-sans text-white bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 rounded-full shadow-md hover:shadow-lg transition-all duration-200"
              >
            ...
            <Link to="/about">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold font-sans text-primary-700 bg-white border border-primary-200 hover:bg-primary-50 hover:border-primary-300 rounded-full shadow-sm transition-all duration-200"
              >
                Our Approach
          ...
          >
            ...
            <div className="w-px h-7 bg-neutral-200 flex-shrink-0" />
            <p className="font-sans text-[11px] text-neutral-400 font-medium">CIW Registered</p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] h-[340px] bg-primary-100/50 rounded-full blur-3xl pointer-events-none"
          />

          {/* ① Main — ChildrenGardening */}
          <motion.div
          ...
          >
            <div className="flex items-center gap-1.5 bg-white/92 backdrop-blur-sm border border-primary-100/70 shadow-soft rounded-full px-3 py-1.5">
              <span className="w-1.5 h-1.5 bg-teal-400 rounded-full" />
              <span className="font-sans text-[10px] font-semibold text-neutral-700 tracking-wide">Curiosity Approach</span>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-1.5 bg-white/92 backdrop-blur-sm border border-teal-100/70 shadow-soft rounded-full px-3 py-1.5">
              <span className="w-1.5 h-1.5 bg-primary-400 rounded-full" />
              <span className="font-sans text-[10px] font-semibold text-neutral-700 tracking-wide">Play-Based Learning</span>
            </div>
          </motion.div>
        </div>
