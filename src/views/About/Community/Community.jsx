...
const PartnerCard = ({ icon: Icon, title, description, link, external = false }) => (
  <motion.div
    ...
    <div className="bg-white/90 backdrop-blur-sm p-8 sm:p-12 rounded-lg2 shadow-lg border border-primary-100 
      ...
      <div className="relative z-10">
        ...
        {link && (
          ...
          >
            {external ? "Visit Website" : "Learn More"}
          </a>
        )}
      </div>
    </div>
  ...
  const partners = [
    {
      ...
      link: "https://www.cardiff.gov.uk/ENG/resident/Schools-and-learning/Early-years-and-child-care/Pages/default.aspx",
      external: true
    },
    {
      icon: FaRocket,
      ...
      link: "https://gov.wales/flying-start",
      external: true
    },
    {
      icon: FaChild,
      title: "Welsh Government Childcare Funding",
      description: "We have signed up for Welsh Government childcare funding schemes including Foundation Phase and Childcare Offer for Wales, providing funded childcare hours for eligible families.",
      link: "/fees/government-funding"
    },
    {
      icon: FaCubes,
      title: "Community Playthings",
      description: "This company makes all the purpose-built furnishings we use at Little Haven.",
      link: "https://www.communityplaythings.co.uk",
      external: true
    }
  ];
